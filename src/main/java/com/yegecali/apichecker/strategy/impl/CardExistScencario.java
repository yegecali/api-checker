...
@ApplicationScoped
public class CardExistScencario implements HealthCheckScenario {

    private static final Logger LOGGER = Logger.getLogger(CardExistScencario.class.getName());
    ...
    public boolean execute() {
        ...
        try {
            String apiUrl = environmentConfigService.getCardApiUrl(environment);
    ...
    public String getName() {
        return "Card Exist API";
    }

    @Override
    public int priority() {
        return 1; // Valor por defecto, será sobrescrito por configuración
    }
